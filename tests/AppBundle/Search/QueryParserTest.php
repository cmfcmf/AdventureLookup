...
class QueryParserTest extends TestCase
{
    ...
    public function parseTokensProvider()
    {
        return [
            ...
            // Quote/bracket in the middle of a string
            ['foo"b(a)r', ['foo"b(a)r']],
    ...
    /**
     * @dataProvider balanceBracketsProvider
     */
    public function testBalanceBrackets($tokens, $result)
    {
        $this->assertEquals($result, QueryParser::balanceBrackets($tokens));
    }

    public function balanceBracketsProvider()
    {
        $OP = new SpecialToken('(');
        $CL = new SpecialToken(')');
        $A = new StringToken('A');
        ...
        return [
            ...
            // ignores brackets that are StringTokens
    ...
    /**
     * @dataProvider convertBracketsToArraysProvider
     */
    public function testConvertBracketsToArrays($tokens, $result)
    {
        $this->assertEquals($result, QueryParser::convertBracketsToArrays($tokens));
    }

    public function convertBracketsToArraysProvider()
    {
        return [
            [[
            ], [
